...
pub fn new(config: &PtyConfig, win_size: WinSize, window_id: Option<usize>) -> Result<Pty> {
    let (master, slave) = make_pty(win_size.to_winsize());
