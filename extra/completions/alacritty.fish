...
complete -c alacritty -n "__fish_alacritty_needs_command" -f -a "ai" -d 'Manage the AI chat panel API key in the OS keyring'
...
complete -c alacritty -n "__fish_alacritty_using_subcommand ai; and not __fish_seen_subcommand_from set-key delete-key help" -s h -l help -d 'Print help'
complete -c alacritty -n "__fish_alacritty_using_subcommand ai; and not __fish_seen_subcommand_from set-key delete-key help" -f -a "set-key" -d 'Store the API key in the OS keyring (read from stdin, not echoed)'
complete -c alacritty -n "__fish_alacritty_using_subcommand ai; and not __fish_seen_subcommand_from set-key delete-key help" -f -a "delete-key" -d 'Remove the API key from the OS keyring'
complete -c alacritty -n "__fish_alacritty_using_subcommand ai; and not __fish_seen_subcommand_from set-key delete-key help" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
complete -c alacritty -n "__fish_alacritty_using_subcommand ai; and __fish_seen_subcommand_from set-key" -s h -l help -d 'Print help'
complete -c alacritty -n "__fish_alacritty_using_subcommand ai; and __fish_seen_subcommand_from delete-key" -s h -l help -d 'Print help'
complete -c alacritty -n "__fish_alacritty_using_subcommand ai; and __fish_seen_subcommand_from help" -f -a "set-key" -d 'Store the API key in the OS keyring (read from stdin, not echoed)'
complete -c alacritty -n "__fish_alacritty_using_subcommand ai; and __fish_seen_subcommand_from help" -f -a "delete-key" -d 'Remove the API key from the OS keyring'
complete -c alacritty -n "__fish_alacritty_using_subcommand ai; and __fish_seen_subcommand_from help" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
complete -c alacritty -n "__fish_alacritty_using_subcommand help; and not __fish_seen_subcommand_from msg migrate ai help" -f -a "msg" -d 'Send a message to the Alacritty socket'
complete -c alacritty -n "__fish_alacritty_using_subcommand help; and not __fish_seen_subcommand_from msg migrate ai help" -f -a "migrate" -d 'Migrate the configuration file'
complete -c alacritty -n "__fish_alacritty_using_subcommand help; and not __fish_seen_subcommand_from msg migrate ai help" -f -a "ai" -d 'Manage the AI chat panel API key in the OS keyring'
complete -c alacritty -n "__fish_alacritty_using_subcommand help; and not __fish_seen_subcommand_from msg migrate ai help" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
...
complete -c alacritty -n "__fish_alacritty_using_subcommand help; and __fish_seen_subcommand_from ai" -f -a "set-key" -d 'Store the API key in the OS keyring (read from stdin, not echoed)'
complete -c alacritty -n "__fish_alacritty_using_subcommand help; and __fish_seen_subcommand_from ai" -f -a "delete-key" -d 'Remove the API key from the OS keyring'
